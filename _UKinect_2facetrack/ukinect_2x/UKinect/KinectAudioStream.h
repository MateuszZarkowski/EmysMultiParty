...
public:
    ...
    /// </summary>
    KinectAudioStream(IMediaObject *pKinectDmo,INuiAudioBeam * pNuiAudioSource);
	...
	bool RecordStart(const std::string& fileName, const WAVEFORMATEX * WaveFormat);
	bool RecordStop();
